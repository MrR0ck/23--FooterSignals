...
> Открыть эту страницу в [https://mrr0ck.github.io/23--footersignals/](https://mrr0ck.github.io/23--footersignals/)
...
* найдите **https://github.com/mrr0ck/23--footersignals** и импортируйте

## Править этот проект ![Значок статуса сборки](https://github.com/mrr0ck/23--footersignals/workflows/MakeCode/badge.svg)

Редактировать этот репозиторий в MakeCode.

* открыть [https://makecode.microbit.org/](https://makecode.microbit.org/)
* нажмите на **Импорт**, затем **Импорт URL**
* вставьте **https://github.com/mrr0ck/23--footersignals** и нажмите Импорт
...
![Отрисовка в виде блоков](https://github.com/mrr0ck/23--footersignals/raw/master/.github/makecode/blocks.png)
